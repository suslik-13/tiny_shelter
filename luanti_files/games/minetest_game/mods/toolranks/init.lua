...
--toolranks.add_tool("ebitems:sword_obsidian")
--toolranks.add_tool("ebitems:flaming_sword")
--toolranks.add_tool("x_obsidianmese:sword")
--toolranks.add_tool("x_obsidianmese:sword_engraved")
--toolranks.add_tool("x_obsidianmese:pick")
--toolranks.add_tool("x_obsidianmese:pick_engraved")
--toolranks.add_tool("x_obsidianmese:shovel")
--toolranks.add_tool("x_obsidianmese:axe")

--toolranks.add_tool("legendary_armor:pickaxe")
--toolranks.add_tool("legendary_armor:shovel")
--toolranks.add_tool("legendary_armor:axe")
--toolranks.add_tool("legendary_armor:sword")
