...
-- custom immune for mask

local _, armor_inv = armor:get_valid_player(player_name, "3d_armor")
	if armor_inv ~= nil then
			for i = 1, 6 do
				local stack = armor_inv:get_stack("armor", i)
					if stack:get_name() == "mask:mask" then
						
						pathogen.immunize( "gosirea" )
						pathogen.immunize( "gravititus" )
						pathogen.immunize( "influencia" )
						pathogen.immunize( "panola" )
