...
home_vending_machines.register_currency("currency:minegeld_10", 1)
...
home_vending_machines.register_machine("simple", "home_vending_machines:drink_machine", {
    ...
    sounds = nil,
    _vmachine = {
        item = {"home_vending_machines:soda_can", "home_vending_machines:water_bottle", "x_farming:corn_popcorn"}
    }
})
...
home_vending_machines.register_machine("simple", "home_vending_machines:sweet_machine", {
    ...
    sounds = nil,
    _vmachine = {
        item = {"home_vending_machines:soda_can", "x_farming:chocolate" }
    }
})
